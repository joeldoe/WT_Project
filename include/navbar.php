<nav class="navbar navbar-default">
  <div class="container-fluid" style="background-color: #53E0BC;">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href= '<?php echo "$index_url"?>' style="font-size: 17.5px; font-family: 'Candara';"><strong>Musafir</strong></a>
    </div>
